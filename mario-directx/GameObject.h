...
#define OBJECT_TYPE_FLOATING_BLOCK	25
#define OBJECT_TYPE_BOOMERANG_BRO	26
#define OBJECT_TYPE_BOOMERANG		27
#define OBJECT_TYPE_FIRE_FLOWER		28

#define RENDER_SCORE_COLORED_BLOCK		1
#define RENDER_SCORE_GROUNDBRICK		2
#define RENDER_SCORE_BRICK				3
#define RENDER_SCORE_VENUS_FIRE_TRAP	4
#define RENDER_SCORE_SHORT_FIRE_TRAP	5
#define RENDER_SCORE_PIRANHA_PLANT		6
#define RENDER_SCORE_TUBE				7
#define RENDER_SCORE_MUSHROOM			8
#define RENDER_SCORE_QUESTIONBRICK		9
#define RENDER_SCORE_SQUARE_BRICK		10
#define RENDER_SCORE_COIN				11
#define RENDER_SCORE_LEAF				12
#define RENDER_SCORE_REWARD				13
#define RENDER_SCORE_GOOMBA				14
#define RENDER_SCORE_KOOPA				15
#define RENDER_SCORE_FIREBALL			16
#define RENDER_SCORE_BULLET				17
#define RENDER_SCORE_BRICK_FRAGMENT		18
#define RENDER_SCORE_FLOATING_BLOCK		19
#define RENDER_SCORE_BOOMERANG_BRO		20
#define RENDER_SCORE_BOOMERANG			21
#define RENDER_SCORE_FIRE_FLOWER		22
